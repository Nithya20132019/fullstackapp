pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://34.229.135.9:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Nithya20132019/fullstackapp.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://34.229.135.9:9090/springapp1"
            echo "✅ Frontend deployed: http://34.229.135.9:9090/frontapp1"
        }
        failure {
